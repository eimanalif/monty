...
void e_pchar(stack_t **head, unsigned int counter);
...
void e_rotl(stack_t **head, unsigned int counter);
void e_rotr(stack_t **head, __attribute__((unused)) unsigned int counter);
void addnode(stack_t **head, int n);
void addqueue(stack_t **head, int n);
void e_queue(stack_t **head, unsigned int counter);
void e_mul(stack_t **head, unsigned int counter);
void e_stack(stack_t **head, unsigned int counter);
